...
namespace Roupa
{
    ...
    partial void DeleteMarca(Lync.Marca instance);
		...
		public NorthwindDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["RoupaConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
...
namespace Lync
{
	...
	public partial class Acessorio : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<double> _PrecoParcelado;
		
		private System.Nullable<int> _PrecoQuantidade;
    ...
    partial void OnPrecoParceladoChanging(System.Nullable<double> value);
    partial void OnPrecoParceladoChanged();
    partial void OnPrecoQuantidadeChanging(System.Nullable<int> value);
    partial void OnPrecoQuantidadeChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PrecoParcelado", DbType="Float")]
		public System.Nullable<double> PrecoParcelado
		{
			get
			{
				return this._PrecoParcelado;
			}
			set
			{
				if ((this._PrecoParcelado != value))
				{
					this.OnPrecoParceladoChanging(value);
					this.SendPropertyChanging();
					this._PrecoParcelado = value;
					this.SendPropertyChanged("PrecoParcelado");
					this.OnPrecoParceladoChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PrecoQuantidade", DbType="Int")]
		public System.Nullable<int> PrecoQuantidade
		{
			get
			{
				return this._PrecoQuantidade;
			}
			set
			{
				if ((this._PrecoQuantidade != value))
				{
					this.OnPrecoQuantidadeChanging(value);
					this.SendPropertyChanging();
					this._PrecoQuantidade = value;
					this.SendPropertyChanged("PrecoQuantidade");
					this.OnPrecoQuantidadeChanged();
				}
			}
		}
