...
namespace Roupa.Negocio
{
    public class Logica
    {
        ...
        public string StringConexao()
        {
            ...
            //return @"Data Source=(local);Initial Catalog=Roupa;Trusted_Connection=Yes;";
        ...
        #region Categoria (Lync to SQL)

        public List<Lync.Categoria> CategoriaListar()
        {
            var categoria = new List<Lync.Categoria>();

            using (NorthwindDataContext db = new NorthwindDataContext())
            {
                categoria = (from e in db.Categorias
                             select e).ToList();
            }
            return categoria;
        }
